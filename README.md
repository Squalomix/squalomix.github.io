...
| #Red stingray *Hemitrygon akajei*  | O | O | | |  | O | O |[Kuraku et al. 2026](https://genome.cshlp.org/content/36/8/1708)|
...
| White-bellied softnose skate *Rhinoraja longicauda*  | O | | ||   | O | O |[Kuraku et al. 2026](https://genome.cshlp.org/content/36/8/1708)|
...
We have released the ['iconHi-C' (inexpensive and controllable Hi-C) protocol](https://github.com/Squalomix/iconhi-c) for versatile Hi-C data acquisition ([Kadota et al., 2018. GigaScience 9: giz158](https://doi.org/10.1093/gigascience/giz158)) and performed Hi-C scaffolding to obtain chromosome-scale genome sequences for diverse species (see [the species list](https://github.com/Squalomix/iconhi-c)). The obtained sequences are validated with original high-fidelity karyotype data provided by our cell culture protocol for elasmobranchs ([Uno et al., 2020. Commun. Biol. 3: 652](https://www.nature.com/articles/s42003-020-01373-7)). 
